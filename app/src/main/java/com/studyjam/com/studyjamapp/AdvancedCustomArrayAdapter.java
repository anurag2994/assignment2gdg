...
public class AdvancedCustomArrayAdapter extends ArrayAdapter<String>{
    ...
    public AdvancedCustomArrayAdapter(
        ...
        myFirebaseRef = new Firebase("https://teamindia.firebaseio.com/");
    ...
    public View getView(int position, View view, ViewGroup parent) {
       ...
       myFirebaseRef.addValueEventListener( new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                viewContainer.txtTitle.setText(String.valueOf(dataSnapshot.child("Members").child(String.valueOf(pos)).child("name").getValue()));
                viewContainer.txtDescription.setText(String.valueOf(dataSnapshot.child("Members").child(String.valueOf(pos)).child("desc").getValue()));
                Picasso.with(getContext()).load(String.valueOf(dataSnapshot.child("Members").child(String.valueOf(pos)).child("imageurl").getValue())).into(viewContainer.imageView);
